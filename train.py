...
# 👇 أضف مجلد src للمسار حتى يستطيع Python إيجاد utils
...
for epoch in range(num_epochs):
    ...
    # ---------------- تقييم على val ----------------
    val_acc, _ = evaluate_model(model, val_loader, device, train_dataset.classes)
...
# -----------------------------
# 7. التقييم على test مع المقاييس
# -----------------------------
test_acc, test_report = evaluate_model(model, test_loader, device, train_dataset.classes)
print(f"\n📊 دقة النموذج على Test = {test_acc*100:.2f}%")
print("\n## Results")
print(test_report)
